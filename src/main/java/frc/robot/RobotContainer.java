...
public class RobotContainer {
  ...
  public final shoot ShootSubsystem = new shoot();

  Joystick left_joystick = new Joystick(0);
  JoystickButton reset_gyro = new JoystickButton(left_joystick, 1);
  JoystickButton shooting_button = new JoystickButton(left_joystick, 0);
  ...
  public RobotContainer() {
        ...
        NamedCommands.registerCommand("Shooting", shoot.Shoot());
